...
class PdoGsb
{
    ...
    public function getInfosVisiteur($login)
    {
        $requetePrepare = $this->connexion->prepare(
            ...
            . 'visiteur.prenom AS prenom, visiteur.comptable AS role '
            . 'FROM visiteur '
    ...
    public function getListeVisiteur()
    {
        $requetePrepare = $this->connexion->prepare(
            ...
            . 'FROM visiteur '
            . 'WHERE visiteur.comptable = false; '
        );
        $requetePrepare->execute();
    ...
    {
        $requetePrepare = $this->connexion->prepare(
            'SELECT distinct fichefrais.mois as date '
            . 'FROM fichefrais '
            . 'ORDER BY fichefrais.mois desc'
        );

        $requetePrepare->execute();
        $dates = $requetePrepare->fetchAll();
        return $dates;
